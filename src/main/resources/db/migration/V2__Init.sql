...
INSERT INTO user_account( first_name, second_name, email, phone_number, student_id)
 VALUES ('Marek','Unknown','pkvs@er.pl','333666959',1);
INSERT INTO user_account( first_name, second_name, email, phone_number, student_id)
 VALUES ('Tom','MrRe','sdf@er.pl','234234',2);
 INSERT INTO user_account(first_name, second_name, email, phone_number, instructor_id)
